...
set PACKAGES_PATH=%WORKSPACE%\edk2-platforms\Platform\Intel;%WORKSPACE%\edk2-platforms\Silicon\Intel;%WORKSPACE%\edk2-non-osi\Silicon\Intel;%WORKSPACE%\FSP;%WORKSPACE%\edk2-platforms\edk2-feature;%WORKSPACE%\edk2-platforms\edk2-minplatform;%WORKSPACE%\edk2;%WORKSPACE%
