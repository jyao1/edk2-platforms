...
::    pcd name and value. FeaturePcd is the full PCD name, like gMinPlatformModulePkgTokenSpaceGuid.PcdOptimizeCompilerEnable
...
@call python %WORKSPACE%\edk2-platforms\edk2-minplatform\MinPlatformModulePkg\Tools\Fsp\RebaseAndPatchFspBinBaseAddress.py %WORKSPACE_PLATFORM%\%PLATFORM_BOARD_PACKAGE%\Include\Fdf\FlashMapInclude.fdf %WORKSPACE_FSP_BIN%\KabylakeFspBinPkg Fsp.fd %WORKSPACE_PLATFORM%\%PROJECT%\OpenBoardPkgPcd.dsc 0x0
